...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('hgrh/css/leaflet.css') }}">
  ...
  <link rel="stylesheet" href="{{ asset('hgrh/css/custom.css') }}">    
</head>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-dark fixed-top" data-bs-theme="dark">
      <div id="container" class="container-fluid">
        <a href="{{url('/')}}" class="navbar-brand">
          ...
          <!-- <img src="{{ asset('hgrh/img/logo.png') }}" alt=""> -->
  ...
  <script src="{{ asset('hgrh/js/custom.js') }}"></script>
</body>
